...
struct menu
{
	...
	struct menu *down;
	char *str; //napis
	void (*function)(char); //wskaznik na funkcje
};
...
struct menu M1 = {&M3, &M2, NULL, &M11, "M1", NULL};
struct menu M11 = {&M13, &M12, &M1, NULL, "M11", &func_menu11};
struct menu M12 = {&M11, &M13, &M1, NULL, "M12", &func_menu12};
struct menu M13 = {&M12, &M11, &M1, &M131, "M13", NULL};
struct menu M131 = {&M132, &M132, &M13, NULL, "M1311", &func_menu1311};
struct menu M132 = {&M131, &M131, &M13, NULL, "M1312", &func_menu1312};

struct menu M2 = {&M1, &M3, NULL, &M21, "M2", NULL};
struct menu M21 = {&M22, &M22, &M2, NULL, "M21", &func_menu21};
struct menu M22 = {&M21, &M21, &M2, NULL, "M22", &func_menu22};

struct menu M3 = {&M2, &M1, NULL, &M31, "M3", NULL};
struct menu M31 = {NULL, NULL, &M3, NULL, "M31", &func_menu31};
