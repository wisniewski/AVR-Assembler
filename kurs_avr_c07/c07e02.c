/*
    Pierwsze podejscie do sprawdzenia lacznego dzialania:
    - wyswietlanie menu na ekranie LCD
    - debouncing 4 przyciskow w przerwaniu, zastosowanie algorytmu
    - uporzadkowanie kodu, funkcje w ISR
*/
